        ...
        <div class="p-6">
          ...
          <div class="mb-6">
            ...
            <div class="grid grid-cols-2 gap-4 text-sm">
              <div class="flex items-center gap-2">
                <div class="w-3 h-3 rounded-full" :class="isNodeVisited(selectedNode.id) ? 'bg-green-500' : 'bg-gray-300'"></div>
                <span>{{ isNodeVisited(selectedNode.id) ? '已访问' : '未访问' }}</span>
              </div>
              <div class="flex items-center gap-2">
                <div class="w-3 h-3 rounded-full" :class="hasNodeStory(selectedNode.id) ? 'bg-blue-500' : 'bg-gray-300'"></div>
