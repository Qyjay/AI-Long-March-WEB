      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
          ...
          <div class="w-20 bg-white bg-opacity-20 rounded-full h-3">
            ...
            >
              <div class="absolute inset-0 bg-gradient-to-r from-transparent to-white opacity-30 animate-pulse" />
            </div>
          </div>
          <!-- 视图切换按钮 -->
          <button
            ...
            <div class="flex items-start gap-3">
              ...
              <div class="flex-shrink-0 mt-1">
                ...
                >
                  ...
                  <div
                    v-else-if="isCurrentNode(node.id)"
                  ...
                  <div class="flex-shrink-0">
                    <div class="w-12 h-1.5 bg-gray-200 rounded-full overflow-hidden">
                      <div
                        ...
                        :style="{ width: getNodeCompletionRate(node) + '%' }"
                      />
                    </div>
                  </div>
                </div>
      ...
      >
        ...
        <div class="sticky top-0 bg-white border-b border-gray-200 p-4 flex items-center justify-between">
          <div class="flex items-center gap-3">
            ...
            >
              <svg
                v-if="isNodeVisited(selectedNode.id)"
              ...
              <div
                v-else-if="isCurrentNode(selectedNode.id)"
                class="w-3 h-3 bg-white rounded-full animate-pulse"
              />
            </div>
            <div>
              <h2 class="text-xl font-bold text-gray-900">
                {{ selectedNode.name_zh || selectedNode.name }}
              </h2>
        ...
        <div class="p-6">
          ...
          <div class="mb-6">
            ...
            <div class="w-full h-3 bg-gray-200 rounded-full overflow-hidden mb-3">
              <div
                class="h-full bg-gradient-to-r from-green-400 to-green-600 transition-all duration-500"
                :style="{ width: getNodeCompletionRate(selectedNode) + '%' }"
              />
            </div>
            <div class="grid grid-cols-2 gap-4 text-sm">
              <div class="flex items-center gap-2">
                <div
                  ...
                  :class="isNodeVisited(selectedNode.id) ? 'bg-green-500' : 'bg-gray-300'"
                />
              ...
              <div class="flex items-center gap-2">
                <div
                  class="w-3 h-3 rounded-full"
                  :class="hasNodeStory(selectedNode.id) ? 'bg-blue-500' : 'bg-gray-300'"
                />
              ...
              <div class="flex items-center gap-2">
                <div
                  class="w-3 h-3 rounded-full"
                  :class="(selectedNode.poem_zh || selectedNode.poem) ? 'bg-purple-500' : 'bg-gray-300'"
                />
              ...
              <div class="flex items-center gap-2">
                <div
                  class="w-3 h-3 rounded-full"
                  :class="getNodeTags(selectedNode).length ? 'bg-orange-500' : 'bg-gray-300'"
                />
          ...
          <div class="mb-6">
            ...
            <p class="text-gray-700 leading-relaxed">
              {{ selectedNode.summary_zh || selectedNode.summary }}
            </p>
            <div
              v-if="selectedNode.description_zh || selectedNode.description"
              class="mt-4"
            >
          ...
          <!-- 诗词内容 -->
          <div
            v-if="selectedNode.poem_zh || selectedNode.poem"
            class="mb-6"
          >
            <h3 class="text-lg font-semibold text-gray-900 mb-3">
              相关诗词
            ...
            <div class="bg-gray-50 rounded-lg p-4">
              <p class="text-gray-800 italic leading-relaxed whitespace-pre-line">
                {{ selectedNode.poem_zh ||
                  selectedNode.poem }}
              </p>
            </div>
          </div>
          ...
          <!-- 节点标签 -->
          <div
            v-if="getNodeTags(selectedNode).length"
            class="mb-6"
          >
            <h3 class="text-lg font-semibold text-gray-900 mb-3">
              节点标签
          ...
          <!-- 时间信息 -->
          <div
            v-if="selectedNode.time_zh || selectedNode.time"
            class="mb-6"
          >
            <h3 class="text-lg font-semibold text-gray-900 mb-3">
              时间信息
            ...
            <div class="bg-blue-50 rounded-lg p-4">
              <p class="text-blue-800 font-medium">
                {{ selectedNode.time_zh || selectedNode.time }}
              </p>
            </div>
          </div>
          ...
          <!-- 历史意义 -->
          <div
            v-if="selectedNode.historical_significance"
            class="mb-6"
          >
            <h3 class="text-lg font-semibold text-gray-900 mb-3">
              历史意义
            ...
            <div class="bg-yellow-50 rounded-lg p-4">
              <p class="text-yellow-800 leading-relaxed">
                {{ selectedNode.historical_significance }}
              </p>
            </div>
          </div>
          ...
          <!-- 环境信息 -->
          <div
            v-if="selectedNode.weather || selectedNode.terrain"
            class="mb-6"
          >
            <h3 class="text-lg font-semibold text-gray-900 mb-3">
              环境信息
          ...
          <div class="mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div
                v-if="selectedNode.lng && selectedNode.lat"
          ...
          <div class="flex gap-3">
            ...
            <button
              v-if="hasNodeStory(selectedNode.id)"
...
const loadNodes = async () => {
  try {
    ...
    // 按时间进行排序，保证默认顺序为时间顺序
    const sorted = sortNodesChronologically(nodesData)

    // 计算节点间距离（如果需要），基于排序后的顺序
    nodes.value = sorted
